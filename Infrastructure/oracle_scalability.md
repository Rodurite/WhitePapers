...
## 1. Problem Statement: The "Cron-Loop" Bottleneck
...
## 2. Design Goals
*   **Instant Responsiveness**: User actions (e.g., clicking "I've Delivered") should trigger immediate checks.
*   **Robustness**: The safety mechanism (refunds) must survive API crashes.
*   **Efficiency**: Polling frequency should match the urgency of the trade.

## 3. Proposed Solution: Priority Worker Architecture
