...
## 1.1 Problem Statement: Public "Ban List" for RMT Participants
...
## 1.2 Design Goals
*   **Anonymity**: Remove direct Roblox identifiers from the blockchain.
*   **Linkage**: Preserve a robust, immutable link between escrows and off-chain listings.
*   **Verifiability**: Keep the oracle capable of performing accurate cross-platform verification.

## 1.3 Proposed Solution: Opaque Listing Identifiers
