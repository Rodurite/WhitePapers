...
## 3.1 Problem Statement: Buyer-Funded Denial of Service
...
## 3.2 Design Goals
*   **Access Control**: Ensure only vetted buyers can fund escrows.
*   **Cost Imposition**: Make large-scale griefing significantly more expensive or infeasible.
*   **User Experience**: Keep the user experience simple for legitimate buyers.

## 3.3 Proposed Solution: Off-Chain Authorized Funding via ECDSA Tickets
